...
const translations: Record<Locale, TranslationKeys> = {
  en: {
    ...
    "dash.title": "Apex Recruiter Dashboard",
  ...
  hi: {
    ...
    "dash.title": "Apex रिक्रूटर डैशबोर्ड",
  ...
  ta: {
    ...
    "dash.title": "Apex ஆட்சேர்ப்பு டாஷ்போர்ட்",
  ...
  bn: {
    ...
    "dash.title": "Apex রিক্রুটার ড্যাশবোর্ড",
  ...
  te: {
    ...
    "dash.title": "Apex రిక్రూటర్ డ్యాష్‌బోర్డ్",
